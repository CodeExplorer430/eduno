    ...
    <AuthenticatedLayout>
        <template #header>
            <nav aria-label="Breadcrumb">
                <ol class="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <li class="font-medium text-gray-800" aria-current="page">{{ user.name }}</li>
                </ol>
            </nav>
        </template>
        ...
        <div class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="grid gap-6 lg:grid-cols-3">
                <!-- User info card -->
                <aside class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
                ...
                <section
                    ...
                    class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100 lg:col-span-2"
                >
                    <div class="flex items-center gap-3 border-b border-gray-100 px-6 py-4">
                        <div class="h-4 w-1 rounded-full bg-blue-500" aria-hidden="true"></div>
                        <h1 id="edit-user-heading" class="font-semibold text-gray-900">
                            Edit User Role
                        </h1>
                    </div>
