        ...
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                >
                    ...
                    <p class="mt-1 text-2xl font-bold text-gray-500">{{ summary.draft }}</p>
                </div>
                <div
                    class="overflow-hidden rounded-xl bg-white px-5 py-4 shadow-sm ring-1 ring-gray-100"
                >
            ...
            >
                <div>
                    ...
                    <select
                        ...
                        class="block w-44 rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
            ...
            <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
                <div class="flex items-center gap-3 border-b border-gray-100 px-6 py-4">
                    ...
                    <h2 class="font-semibold text-gray-900">All Courses</h2>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-100" aria-label="Course list">
                        ...
                        <tbody class="divide-y divide-gray-100 bg-white">
                            ...
                            >
                                <td
                                    class="whitespace-nowrap px-6 py-4 font-mono text-sm font-medium text-gray-900"
                                >
                                    {{ course.code }}
                                </td>
                                ...
                                <td class="whitespace-nowrap px-6 py-4">
                                    <div
                                        class="inline-flex overflow-hidden rounded-lg border border-gray-200 text-xs"
                                        role="group"
                                    ...
                                    >
                                        <button
                                            ...
                                            "
                                            class="border-r border-gray-200 px-2 py-1 last:border-r-0 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
