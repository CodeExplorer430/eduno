...
const form = useForm({
    ...
    order_no: props.module.order_no,
    published: props.module.published_at !== null,
});

const submit = (): void => {
    form.patch(
        route('instructor.courses.modules.update', {
...
<template>
    <Head :title="`Edit Module — ${section.course.code}`" />
            ...
            <div class="mx-auto max-w-xl sm:px-6 lg:px-8">
                <div class="overflow-hidden rounded-lg bg-white shadow-sm">
                    <div class="border-b border-gray-100 px-6 py-4">
                        <h1 class="font-semibold text-gray-800">Edit Module</h1>
                    </div>
