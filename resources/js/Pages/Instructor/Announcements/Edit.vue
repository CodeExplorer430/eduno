...
const form = useForm({
    course_section_id: props.announcement.course_section_id,
    title: props.announcement.title,
    body: props.announcement.body,
});

function submit(): void {
    form.patch(route('instructor.announcements.update', props.announcement.id));
}
</script>
        ...
        <div class="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            >
                ...
                >
                    ...
                    <h1 class="font-semibold text-gray-900 dark:text-white">Edit Announcement</h1>
                </div>
                ...
                <form class="px-6 py-6 space-y-5" novalidate @submit.prevent="submit">
                    ...
                    <!-- Published note -->
                    <p v-if="announcement.published_at" class="text-xs text-green-700">
                        This announcement is currently published.
                    </p>
                    <p v-else class="text-xs text-yellow-600">This announcement is a draft.</p>
