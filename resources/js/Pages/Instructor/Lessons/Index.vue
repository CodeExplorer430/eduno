        ...
        <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
            <header class="mb-6 flex flex-wrap items-start justify-between gap-4">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">
                        {{ props.module.title }}
                        <span class="text-base font-normal text-gray-500">— Lessons</span>
                    </h1>
                    <p v-if="props.section.course" class="mt-1 text-sm text-gray-500">
            ...
            <div v-else class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100">
                <div class="flex items-center gap-3 border-b border-gray-100 px-6 py-4">
                    ...
                    <h2 class="font-semibold text-gray-900">Lesson List</h2>
                ...
                <ul class="divide-y divide-gray-100" role="list" aria-label="Lessons">
                    <li
                    ...
                    >
                        <div class="flex min-w-0 items-center gap-3">
                            <span
                                class="w-6 shrink-0 text-center text-xs font-medium text-gray-400"
                                aria-hidden="true"
                            >
                                {{ lesson.order_no }}
                            </span>
                            <span
                                ...
                                :class="typeBadgeClass[lesson.type] ?? 'bg-gray-100 text-gray-700'"
                            >
                                {{ lesson.type }}
                            </span>
                            <p class="truncate font-medium text-gray-900">{{ lesson.title }}</p>
                            <span
