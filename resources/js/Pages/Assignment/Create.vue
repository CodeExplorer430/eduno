...
<template>
    <Head :title="`New Assignment — ${section.section_name}`" />
    ...
    <main class="mx-auto max-w-2xl px-4 py-8">
        <nav aria-label="Breadcrumb" class="mb-4">
            <ol class="flex gap-2 text-sm text-gray-500 dark:text-slate-400">
                <li>
                    <Link
                        :href="route('sections.assignments.index', section.id)"
        ...
        <h1 class="mb-6 text-2xl font-bold">New Assignment</h1>
            ...
            <div class="space-y-5">
                ...
                <div class="flex items-center gap-3">
                    <input
                        ...
                        type="checkbox"
                        class="h-4 w-4 rounded border-gray-300 dark:border-slate-600 text-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
                    />
                    <label
