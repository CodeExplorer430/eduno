        ...
        <form class="mt-6 space-y-6" @submit.prevent="form.patch(route('profile.update'))">
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="mt-2 text-sm text-gray-800 dark:text-gray-200">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="rounded-md text-sm text-gray-600 underline hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:text-gray-400 dark:hover:text-gray-200"
                    >
            ...
            <div>
                ...
                <textarea
                    ...
                    v-model="form.bio"
                    rows="4"
                    class="mt-1 block w-full resize-y rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-slate-600 dark:bg-slate-800 dark:text-white"
