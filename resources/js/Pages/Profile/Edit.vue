...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h1 class="text-xl font-semibold leading-tight text-gray-800">Profile</h1>
        </template>
        ...
        <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            >
                ...
                >
                    <div class="flex items-center gap-3 border-b border-gray-100 px-6 py-4">
                        <div class="h-4 w-1 rounded-full bg-blue-500" aria-hidden="true"></div>
                        <h2 class="font-semibold text-gray-900">Accessibility Preferences</h2>
                    </div>
                    <div class="px-6 py-5">
            ...
            >
                <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-red-100">
